...
async def process_single_text(text: str) -> dict | None:
    ...
    return {
        ...
        "canton": canton,
        "contract_type": processed.get("contract_type", "full_time"),
        ...
        "category_slug": processed.get("category_slug", "inne"),
        "car_required": processed.get("car_required", False),
        "driving_license_required": processed.get("driving_license_required", False),
